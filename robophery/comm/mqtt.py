...
class MqttComm(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._subscribe_topic = kwargs.get('subscribe_topic', 'robophery_sub/{0}#'.format(self._manager._name))
        self._publish_topic = kwargs.get('publish_topic', 'robophery_pub/{0}'.format(self._manager._name))
